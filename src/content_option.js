...
const onboarding = {
    ...
    GoalsTitle: "Processus",
    GoalsTxt:"Après le projet StayAlive et les présentations qui ont suivi, l'idée de l'onboarding est restée au centre de mes préoccupations. J'ai eu pour objectif de créer un onboarding interactif en amont du niveau, offrant aux utilisateurs une meilleure compréhension des interactions possibles et de la prise en main de l'outil, tout en intégrant des éléments informatifs et graphiques dans un environnement 3D. J'ai entamé le processus en définissant les interactions essentielles, leur priorité et les contrôles à utiliser, en effectuant une recherche approfondie sur les différents contrôleurs disponibles et leurs applications dans divers jeux et expériences. La scène a été construite pour guider les utilisateurs à travers un onboarding étape par étape, tout en leur permettant d'explorer et de tester les différentes commandes disponibles. La première étape de production a impliqué la modélisation de la pièce et des éléments nécessaires, en parallèle de la recherche d'assets 3D en raison de contraintes temporelles. Enfin, la production et le développement de l'expérience ont pu démarrer.",
    GoalsTxt2:"",
    DeroulementTxt: "Devlog - Retour",
    DeroulementTxt2: "En regardant en arrière, je pense que la force de ce projet est l'idée de vouloir le rendre modulaire, il a pour objecctif de pouvoir évoluer en fontion du thème et des outils utilisés. LA faiblesse du projet et son absence de QA test, afin de pouvoir le finaliser et l'améliorer, un étape de test est nécessaire pour savoir si l'introduction des controllers est compréhensible et voir les intéractions réalisé par l'utilisateurs. Je pense qu'un évolution des panneaux et du déroulement du niveau serait alors observable. Je pense également que la production aurait put être plus efficace avec un casque VR plus à jour, le developpement à été effectué pour un casque VR Dell datant de 2017, certain plugin facilitant la programmation d'interaction n'était alors pas accessible.",
...
const MR = {
    ...
    ResumeTitle: "Présentation",
    ResumeTxt: "HoloDraw est un projet sur HoloLens en Mixte Reality, multijoueur. Il s'agit d'une expérience permettant à plusieurs utilisateurs de se connecter à distance afin de dessiner ensemble. Se projet est un POC permettant de mettre en avant les possibilités qu'apporte la MR et l'espace collaboratif que cela propose. Le projet a été produit en plusieurs fois, nous en sommes aujourd'hui à sa troisième version sur une période d'environs 4mois. Chaque version a été développé par une personne différente, j'ai eu toutefois la chance de pouvoir participer a chaque étape.",
    GoalsTitle: "Processus",
    GoalsTxt:"La première version découle de ma thèse professionnel : les technologies XR peuvent elles être un source d'aide pour les personnes en situation de handicap cognitif. Lors de la rédaction de la thès nous étions invité à réalisé un prototype et de le faire tester. J'avais imaginé un prototype sur HoloLens permettant à plusieurs personnes de communiquer ensemble, le prototype avais pour but de faire tester l'HoloLens, les gestes qui en découle et voir si un support visuel pouvait aides les personnes en situation de handicap cognitif à mieux communiqué. Le manque de temps, de matériel et l'organisation n'ayant pas pu aboutir, ce prototype à été éffectué en parallèle et continué en dehors de ma thèse. La première version à servi de POC, la seconde version à été reprise par un collègue pendant mon absence pour nettoyer le code et améliorer les performances. Cette seconde version nous à permis de tester l’expérience sur un large panel d'utilisateur et d'identifié ses limites. La troisième version à été éffectué par un autre collègue développeur qui à repris nos deux codes, à repris les maquettes que j'avais effectué pour faciliter les intéractions et améliorer les HUD. L'intéraction à ainsi évoluer pour permettre une meilleure liberté à l'utilisateur.",
    GoalsTxt2: "",
    DeroulementTxt: "Devlog - Retour",
    DeroulementTxt2: "En regardant en arrière, je pense que la force de notre projet est le developpement des différentes versions cela nous à permis de faire évoluer la solution suite aux retours des utilisateurs. Notre faiblesses elle est lié aux changement des developpeur et la communication. En changeant trois fois de developpeur, chacun à dû apprendre le fonctionnement des assets utilisé, reprendre à zero, ce qui nous a fait perdre du temps. Le second développeur, ayant passer le plus de temps dessus étant parties avec la version 3, une perte de connaissance et de communication a été fortement ressentie, de même que la version 2 ayant commencé pendant mon absence, je n'ai pas pu proprement passer les informations, les points importants et expliquer le processus réalisé, cela a été très visible notamment sur l'intéraction du dessin qui a été completement modifié entre la version 1 et 2 et retrouvé pour la 3. En faisant tester la version 2, nous nous sommes rendu compte qu'en proposant un stylo a déplacer pour dessiner créer une contrainte pour l'utilisateeur, de plus certain utilisateur perdaient leurs crayons voir les boutons du panneau principal. En observant ceci, j'ai effectué une veille notamment sur les outils de microsoft tel que Guide 365 et Remote assist, des outils disponible sur HoloLens, et ai effectué des maquettes des boutons du panneau principal et ai écrit comment s'effectuer les interactions en prenant le temps de bien en reparler avec le nouveau developpeur pour une version 3.",
...
const research = {
    ...
    ResumeTitle: "Présentation",
    ResumeTxt: "Cet aparté est là pour présenter le processus de travail effectué lors  d'une présentation client. En effet, dans le cadre actuel de mes tâches  il m'est arrivé de prendre le rôle de Consultant UX lors de  présentations clients, afin d'identifier comment et est-ce que les  expériences immersive peuvent les aider. L'idée étant à travers ses  recherches de mieux comprendre le client, ses activités, ses employés et  son activités. Une fois identifié une phase d'étude est effectué afin  de savoir ce qui peux être pertinent de lui montrer, quels sont les  usercases et quel ton utilisés.",
    GoalsTitle: "Processus",
